...
function isPlainObject$1(value) {
	...
	if (proto$1 === null || proto$1 === O[PROTOTYPE]) return true;
	const Ctor = O.hasOwnProperty.call(proto$1, CONSTRUCTOR) && proto$1[CONSTRUCTOR];
...
function handleCrossReference(target, key, value) {
	...
	if (isDraft(value)) {
		...
		if (get(latest(target), key, target.type_) === value) {
...
var runIdentityFunctionCheck = (resultFunc, inputSelectorsResults, outputSelectorResult) => {
	if (inputSelectorsResults.length === 1 && inputSelectorsResults[0] === outputSelectorResult) {
		...
		try {
			const emptyObject$1 = {};
			if (resultFunc(emptyObject$1) === emptyObject$1) isInputSameAsOutput = true;
		} catch {}
